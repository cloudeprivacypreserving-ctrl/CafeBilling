...
const DialogHeaderComponent = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div className={cn('flex flex-col space-y-1.5 text-center sm:text-left', className)} {...props} />
)
DialogHeaderComponent.displayName = 'DialogHeader'

const DialogFooterComponent = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
